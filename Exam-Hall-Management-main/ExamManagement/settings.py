...
SECRET_KEY = 'django-insecure-z06_3yw067ol=#o95)f^@ec)@-h0+#p4nlk+nm+#1626b@+4p5'
...
LOGIN_URL = 'exam:admin_login'  # Default login URL
LOGIN_REDIRECT_URL = 'exam:admin_dashboard'  # Default redirect after login
